...
import os
os.environ['TRANSFORMERS_CACHE'] = 'D:\Programming\.cache'
...
if package_spec is None:
    ...
    print(package_name +" found")


openai.api_key = "EMPTY" # Key is ignored and does not matter
openai.api_base = "http://zanino.millennium.berkeley.edu:8000/v1" # Change this once I have the local access file
        ...
        if len(input_prompt) > 0:
            ...
            with col2:
                ...
                if option == "gorilla-7b-hf-v1":
                    ...
                    file_path = "generated_code/generated_code_gorilla_7b_hf_v1.py"
                    ...
                    file_path = "generated_code/generated_code_gorilla_mpt_7b_hf_v0.py"
